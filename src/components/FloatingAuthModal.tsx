      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-8 relative"
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                {mode === 'signin' ? 'Sign in to your account' : 'Create your FocusMate AI account'}
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <button
                ...
                disabled={isLoading}
                className="mt-4 w-full flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors disabled:opacity-50"
              >
